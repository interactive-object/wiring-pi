...
exports.softPwmCreate = function softPwmCreate(pin, value, range) {
  validatePin(pin);
  return c.softPwmCreate(pin, value, range);
};

// softPwmWrite (int pin, int value) ;
exports.softPwmWrite = function softPwmWrite(pin, value) {
  validatePin(pin);
  c.digitalWrite(pin, value);
};
